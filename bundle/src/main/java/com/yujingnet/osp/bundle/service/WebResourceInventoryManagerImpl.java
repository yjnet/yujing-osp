...
import com.yujingnet.osp.bundle.webresource.WebResourceInventoryManager;
import com.yujingnet.osp.bundle.webresource.model.WebResourceGroup;
import com.yujingnet.osp.bundle.webresource.util.JCRUtils;
...
@Component(immediate = true) // (metatype = true, immediate = true)
@Service
public class WebResourceInventoryManagerImpl implements WebResourceInventoryManager {
	@Reference
